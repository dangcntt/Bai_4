  ...
  methods: {
    ...
    async getMenu() {
      ...
      if (menuStorage) {
        ...
        this.menuName = this.menu ? this.menu.name : "";
    ...
    async getGioiThieu() {
      ...
      const params = {
        ...
        sortDesc: true,
        menuId:
          this.menu != null && this.menu.id != null
            ? this.menu.id
            : this.$route.params.id,
      };
      await this.$store
        .dispatch("contentStore/getByMenuId", params)
        .then((res) => {
          //   console.log("MENU CATEGORY: ", res.data)
          if (
            res.data != null &&
            res.data.data != null &&
            ...
            //   console.log("KHÔNG LA ARRAY: ", res.data)
            this.isArray = false;
            this.model = res.data;
            this.model.noiDung = this.model.noiDung.replaceAll(
              "https://localhost:5001/api/v1/filesminio/view",
              this.url
            );
          }
        });
                    ...
                    <div class="row">
                      <div class="col-lg-9 mb-2">
                        <div class="row">
                          ...
                          <div class="col-lg-12" v-if="isArray">
                            <section>
                              <div class="row">
                                <div class="col-lg-12">
                                  <div
                                  ...
                                  >
                                    <div class="col-md-12 mb-4">
                                      <b-card no-body class="card-box">
                                        <b-row
                                          no-gutters
                                          class="align-items-center card-intro"
                                        >
                                          <span
                                            ...
                                            >
                                              ...
                                              >
                                                ...
                                                >
                                                  Chi tiết
                                                  <i
                                                    class="mdi mdi-arrow-right ps-2"
                                                  ></i>
                                                </b-button>
                                              </b-card-body>
                                            </router-link>
                          ...
                          <div class="col-lg-12" v-else>
                            <div
                              class="col-md-12 mt-3 noidung"
                              style="font-size: 14px; text-align: justify"
                            >
                              <p v-html="model.noiDung"></p>
                            </div>
                            <div
                              v-for="(item, index) in this.model.files"
                              :key="index"
                              style="
                                margin-top: 20px;
                              ...
                              >
                                <div class="font-size-13">
                                  <span
                                    ...
                                    >TỆP ĐÍNH KÈM
                                    <i
                                      class="mdi mdi-chevron-double-right font-size-20"
                                      aria-hidden="true"
                                    ></i>
                                  </span>
                                  <i
                                    :class="`${getColorWithExtFile(
                                      item.ext
                                    )} me-2 ${getIconWithExtFile(item.ext)}`"
                                  ></i>
                                  <span
                                    style="
                                      font-weight: bold;
                      ...
                      <div class="col-lg-3">
                        <div class="category">
                          <div class="cate-title">Danh Mục</div>
                          <div
                            v-for="(item, index) in listDanhMuc"
                            :key="index"
                            class="cate-list"
                          >
