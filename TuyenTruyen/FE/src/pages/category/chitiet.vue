  ...
  methods: {
    ...
    async getTinLienQuan() {
      ...
      if (this.model._id != null) {
        await this.$store
          .dispatch("contentStore/getTinKhac", params)
          .then((res) => {
            if (res.code === 0) {
                ...
                <div class="col-lg-12">
                  <div class="container">
                    <div class="row">
                      ...
                      <div class="col-lg-3">
                        <div class="category">
                          <div class="cate-title">Danh Mục1</div>
                          <div
                    ...
                    <template v-if="tinlienquan.length > 0">
                      <div class="related row">
                        ...
                        <section>
                          <div class="row">
                            <div
                              v-for="(item, index) in tinlienquan"
                              :key="index"
