            ...
            try
            {
                ...
                if (!String.IsNullOrEmpty(pagingParam.Content))
                {
                    filter = builder.And(filter,
                       ...
                       | builder.Regex("DiaChi", new BsonRegularExpression(pagingParam.Content, "i"))
                         | builder.Regex("TenNguoiMua", new BsonRegularExpression(pagingParam.Content, "i"))
                        );
                }
                
                
                if (pagingParam.TrangThaiId != null && !pagingParam.TrangThaiId.Equals(""))
                {
                    filter = builder.And(filter,
                        builder.Eq("TrangThai.Id", pagingParam.TrangThaiId)
                    );
                }
